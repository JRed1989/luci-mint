...
class IndexCommandQueue {
	...
	public synchronized IndexCommand pollFirst(){
		...
		if(first != null){
			if(Operate.ADD == first.getOperate()
					|| Operate.MODIFY == first.getOperate()
					|| Operate.DELETE == first.getOperate()
					){
	...
	public synchronized IndexCommand pollLast(){
		...
		if(last != null){
			if(Operate.ADD == last.getOperate()
					|| Operate.MODIFY == last.getOperate()
					|| Operate.DELETE == last.getOperate()
					){
